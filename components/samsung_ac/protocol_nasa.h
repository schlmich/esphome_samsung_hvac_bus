...
VAR_LONG_xx_MINUTES SINCE INSTALLATION = 0x4423,
VAR_LONG_xx_MINUTES ACTIVE = 0x4424,
ENUM_xx_INDOOR UNIT DEFROST OPERATION STEPS = 0x8000,
ENUM_xx_COMP#1 ON/OFF = 0x8010,
...
ENUM_xx_REFRIGERANT AMOUNT LEVEL = 0x808e,
...
VAR_xx_NUMBER OF OUTDOOR UNIT COMPRESSORS = 0x8202,
VAR_xx_NASA_OUTDOOR_DISCHARGE_TEMP1 = 0x820a,
VAR_xx_COMPRESSOR 1 CURRENT = 0x8217,
VAR_xx_MAIN HEAT EXCHANGER OUTLET TEMPERATURE = 0x8218,
VAR_xx_SUCTION TEMPERATURE = 0x821a,
VAR_xx_TARGET DISCHARGE TEMPERATURE = 0x8223,
VAR_xx_MAIN EEV1 = 0x8229,
VAR_xx_MAIN EEV2 = 0x822a,
VAR_xx_MAIN EEV3 = 0x822b,
VAR_xx_MAIN EEV4 = 0x822c,
VAR_xx_MAIN EEV5 = 0x822d,
...
VAR_xx_DC LINK1 (INVERTER DC VOLTAGE INPUT) = 0x823b,
...
VAR_xx_REFRIGERANT AMOUNT = 0x824f,
VAR_xx_IPM1 TEMPERATURE = 0x8254,
...
VAR_LONG_xx_INSTANTANEOUS POWER CONSUMPTION OF OUTDOOR UNIT. ONE OUTDOOR UNIT. NOT USED BY THE CONTROLLER. = 0x8411,
